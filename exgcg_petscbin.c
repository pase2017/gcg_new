...
int main(int argc, char* argv[])
{
    ...
    Vec            *evec, vec_tmp;
    PetscErrorCode ierr;
    PetscInt       eigen_max_iter = 50, nev = 50, cg_max_iter = 1000, if_giveninit = 0;
    PetscReal      *eval, eigen_tol = 5e-2, cg_rate = 1e-1;
    ...
    //ierr = GCG_Eigen(A, B, eval, evec, nev, eigen_tol, cg_rate, cg_max_iter, eigen_max_iter, 0);CHKERRQ(ierr);
    ierr = GCG_Eigen(A, B, eval, evec, nev, eigen_tol, eigen_max_iter);CHKERRQ(ierr);
